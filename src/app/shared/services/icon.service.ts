...
//creacion de interface para inyectar muchos iconos
interface IIcon {
  name: string;
  path: string;
}
...
export class IconService {
  ...
  registryIcons() {
    ...
    //registrar un icono/*this.matIconRegistry.addSvgIcon('tablero', this.domSanitizer.bypassSecurityTrustResourceUrl('../assets/icons/tablero.svg'));*/
  }
}
